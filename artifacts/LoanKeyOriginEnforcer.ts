export default {
  ...
  constructorInputs: [
    { name: 'loanKeyFactoryTokenId', type: 'bytes' },
    { name: 'paryonTokenId', type: 'bytes' },
  ],
  abi: [
    { name: 'enforce', inputs: [] },
  ],
  ...
  fingerprint: 'aecf4415c2b49de5172a1ab70b3875503f23aa263c5a6b2a22722bd8dde76425',
  debug: {
  ...
  updatedAt: '2026-06-12T15:14:10.647Z',
} as const;
