export default {
  ...
  constructorInputs: [
    { name: 'paryonTokenId', type: 'bytes32' },
  ],
  abi: [
    { name: 'addToPool', inputs: [] },
  ],
  ...
  fingerprint: 'f46099a7e734f5f0ec466ae997296e8ade8be45426394adda6bf61977fe478fa',
  debug: {
    ...
    requires: [
      ...
      { ip: 45, line: 52 },
      { ip: 49, line: 53 },
      { ip: 63, line: 64, message: 'Invalid receipt, should have correct tokenId' },
      { ip: 70, line: 66, message: 'Invalid receipt, should have correct nftCommitment' },
      { ip: 74, line: 67 },
      { ip: 90, line: 73 },
      { ip: 100, line: 78, message: 'Invalid BCH change output - should not hold any tokens' },
      { ip: 105, line: 82, message: 'Invalid number of outputs - should have 6 at most' },
    ],
  },
  compiler: {
    name: 'cashc',
  ...
  updatedAt: '2026-06-12T15:14:17.588Z',
} as const;
