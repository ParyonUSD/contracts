export default {
  ...
  constructorInputs: [
    { name: 'redeemerTokenId', type: 'bytes32' },
  ],
  abi: [
    { name: 'startRedemption', inputs: [] },
  ],
  ...
  debug: {
    ...
    requires: [
      ...
      { ip: 30, line: 40 },
      { ip: 40, line: 46 },
      { ip: 64, line: 60, message: 'redemptionAmount loan needs to be in valid range' },
      { ip: 69, line: 63 },
      { ip: 79, line: 69, message: 'Invalid state loan contract - wrong nftCommitment' },
      { ip: 84, line: 70, message: 'Recreate loan contract - invalid lockingBytecode' },
      { ip: 89, line: 71, message: 'Recreate loan contract with same BCH amount' },
      { ip: 94, line: 72, message: 'Recreate loan contract - invalid tokenCategory' },
      { ip: 98, line: 73, message: 'Recreate loan contract - should have zero token amount' },
      { ip: 103, line: 76 },
      { ip: 108, line: 77 },
      { ip: 113, line: 78 },
      { ip: 117, line: 79 },
  ...
  updatedAt: '2026-06-12T15:14:14.039Z',
} as const;
