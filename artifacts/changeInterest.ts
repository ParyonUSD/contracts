export default {
  ...
  abi: [
    {
      name: 'changeInterest',
      inputs: [
        { name: 'nextInterestRate', type: 'bytes2' },
      ],
    },
  ],
  ...
  debug: {
    ...
    requires: [
      ...
      { ip: 45, line: 47 },
      { ip: 66, line: 52 },
      { ip: 77, line: 58, message: 'Next interest rate out of range for manager - below minimum' },
      { ip: 84, line: 60, message: 'Next interest rate out of range for manager - exceeds maximum' },
      { ip: 101, line: 68, message: 'Recreate loan contract - invalid lockingBytecode' },
      { ip: 106, line: 69, message: 'Recreate loan contract - invalid tokenCategory' },
      { ip: 109, line: 70, message: 'Invalid state loan contract - wrong nftCommitment' },
      { ip: 115, line: 71, message: 'Recreate loan contract with same or higher BCH amount' },
      { ip: 119, line: 72, message: 'Recreate loan contract - should have zero token amount' },
      { ip: 124, line: 75 },
      { ip: 129, line: 76 },
      { ip: 134, line: 77 },
      { ip: 138, line: 78 },
      { ip: 142, line: 79 },
      { ip: 147, line: 82, message: 'Recreate loanKey or loanManagementToken - invalid lockingBytecode' },
      { ip: 152, line: 83, message: 'Recreate loanKey or loanManagementToken - invalid tokenCategory' },
      { ip: 157, line: 84, message: 'Recreate loanKey or loanManagementToken - invalid nftCommitment' },
      { ip: 163, line: 85, message: 'Recreate loanKey or loanManagementToken - invalid value' },
    ],
  },
  compiler: {
    name: 'cashc',
  ...
  updatedAt: '2026-06-12T15:14:11.598Z',
} as const;
