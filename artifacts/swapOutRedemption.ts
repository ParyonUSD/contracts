export default {
  ...
  constructorInputs: [
    { name: 'redemptionTokenId', type: 'bytes32' },
  ],
  abi: [
    { name: 'swapOutRedemption', inputs: [] },
  ],
  ...
  debug: {
    ...
    requires: [
      ...
      { ip: 36, line: 43 },
      { ip: 44, line: 51 },
      { ip: 59, line: 60, message: 'Invalid state loan contract - wrong nftCommitment' },
      { ip: 64, line: 61, message: 'Recreate loan contract - invalid lockingBytecode' },
      { ip: 69, line: 62, message: 'Recreate loan contract with same BCH amount' },
      { ip: 74, line: 63, message: 'Recreate loan contract - invalid tokenCategory' },
      { ip: 78, line: 64, message: 'Recreate loan contract - should have zero token amount' },
      { ip: 83, line: 67 },
      { ip: 88, line: 68 },
      { ip: 93, line: 69 },
      { ip: 97, line: 70 },
  ...
  updatedAt: '2026-06-12T15:14:15.026Z',
} as const;
