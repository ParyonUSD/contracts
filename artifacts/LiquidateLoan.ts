export default {
  ...
  fingerprint: '36e03cd17e0a2189716dd0eab39169baeca44285bba41a679f42084aee2753f7',
  debug: {
    ...
    requires: [
      ...
      { ip: 115, line: 82 },
      { ip: 124, line: 83 },
      { ip: 132, line: 87, message: 'Invalid BCH change output - should not hold any tokens' },
      { ip: 137, line: 91 },
    ],
  },
  compiler: {
  ...
  updatedAt: '2026-06-12T15:14:18.048Z',
} as const;
