export default {
  ...
  constructorInputs: [
    { name: 'stabilityPoolTokenId', type: 'bytes32' },
  ],
  abi: [
    { name: 'liquidate', inputs: [] },
  ],
  ...
  fingerprint: 'b4da0b289db66d049fe5787e92f1aed8bff78b1b02ed817287377de01ff939f3',
  debug: {
    ...
    requires: [
      ...
      { ip: 47, line: 46 },
      { ip: 54, line: 50 },
      { ip: 77, line: 63, message: 'Invalid liquidation, collateral ratio not below liquidation threshold' },
      { ip: 82, line: 70 },
      { ip: 87, line: 71 },
      { ip: 92, line: 72 },
      { ip: 96, line: 73 },
  ...
  updatedAt: '2026-06-12T15:14:12.099Z',
} as const;
